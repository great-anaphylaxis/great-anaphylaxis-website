...
function createPost(postData) {
    ...
    */
    ...
    username.href = "/u/" + postData.username + "/profile.html";

    // profile image
    let profile_image = e("img", "profile_image", username);
    profile_image.src = "/u/" + postData.username + "/profile.png";
    ...
    if (IDIsInArray(postData.id, liked_posts) == true) {
        ...
        like_button.src = "/content/icons/heart.png";
    }
    else {
        // else, set it to empty heart
        like_button.src = "/content/icons/empty_heart.png";
    }
    ...
    let likePostFunction = e => {
        ...
        if (last_unliked_post != null && IDIsInArray(last_unliked_post, liked_posts) == false) {
            ...
            post.like_button.src = "/content/icons/empty_heart.png";
        }
        ...
        if (IDIsInArray(postData.id, liked_posts) == true) {
            ...
            // change button icon
            like_button.src = "/content/icons/unheart.png";
